...
package riscvDebug013Pbuf;
  ...
  module mkriscvDebug013(Ifc_riscvDebug013);
    ...
    /*    System Bus ACCESS   */
  `ifdef CORE_AXI4
    AXI4_Master_Xactor_IFC#(DPADDR, `id_width, D_AXI_BUS_WIDTH , `USERSPACE ) master_xactor <- mkAXI4_Master_Xactor;
    AXI4_Slave_Xactor_IFC#(DPADDR, `id_width, D_AXI_BUS_WIDTH , `USERSPACE ) slave_xactor <- mkAXI4_Slave_Xactor;
  `elsif CORE_AXI4Lite
  ...
  `endif
    ...
    rule read_request_first;
      ...
      AXI4_Rd_Data#(`id_width, D_AXI_BUS_WIDTH, `USERSPACE ) r = AXI4_Rd_Data {rresp: AXI4_OKAY,
        rdata: lv_response, 
        rlast:True ,
        ruser: 0,
        rid:ar.arid };
