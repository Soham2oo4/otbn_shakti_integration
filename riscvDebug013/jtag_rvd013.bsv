package jtag_rvd013;
  ...
  module mkdummy(Empty);
    ...
    Ifc_jtagdtm jtag_tap <- mkjtagdtm(defaultclk,clocked_by tck_clk.new_clk, reset_by trst.new_rst);
    ...
    rule rl_wr_tdo;
      wr_tdo <= jtag_tap.tdo(); //  Launched by a register clocked by inverted tck
    endrule
