  ...
  */
  ...
  `else
    interface Ifc_riscvDebug013;
      ...
      interface Debug_Hart_Ifc hart;
    `ifdef CORE_AXI4
      interface AXI4_Master_IFC#(DPADDR, `id_width, D_AXI_BUS_WIDTH, `USERSPACE ) debug_master;
      interface AXI4_Slave_IFC#(DPADDR, `id_width, D_AXI_BUS_WIDTH , `USERSPACE ) debug_slave;
    `elsif CORE_AXI4Lite
      interface AXI4_Lite_Master_IFC#(DPADDR, DXLEN, 0 ) debug_master;
