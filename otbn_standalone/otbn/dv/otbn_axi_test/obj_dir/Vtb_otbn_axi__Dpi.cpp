...
//    1. Call Vtb_otbn_axi::{export_function} instead,
//       and do not even bother to compile this file
// or 2. Compile all __Dpi.cpp files in the same compiler run,
//       and #ifdefs already inserted here will sort everything out.

#include "Vtb_otbn_axi__Dpi.h"
...
int simutil_get_mem(int index, svBitVecVal* val) {
    ...
    return Vtb_otbn_axi::simutil_get_mem(index, val);
}
#endif
...
int simutil_get_scramble_key(svBitVecVal* val) {
    ...
    return Vtb_otbn_axi::simutil_get_scramble_key(val);
}
#endif
...
int simutil_get_scramble_nonce(svBitVecVal* nonce) {
    ...
    return Vtb_otbn_axi::simutil_get_scramble_nonce(nonce);
}
#endif
...
void simutil_memload(const char* file) {
    ...
    return Vtb_otbn_axi::simutil_memload(file);
}
#endif
...
int simutil_set_mem(int index, const svBitVecVal* val) {
    ...
    return Vtb_otbn_axi::simutil_set_mem(index, val);
}
#endif
