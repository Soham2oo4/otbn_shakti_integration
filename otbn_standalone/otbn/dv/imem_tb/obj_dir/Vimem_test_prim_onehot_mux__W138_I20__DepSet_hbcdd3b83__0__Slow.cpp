...
VL_ATTR_COLD void Vimem_test_prim_onehot_mux__W138_I20___ctor_var_reset(Vimem_test_prim_onehot_mux__W138_I20* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vimem_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vimem_test_prim_onehot_mux__W138_I20___ctor_var_reset\n"); );
    // Body
