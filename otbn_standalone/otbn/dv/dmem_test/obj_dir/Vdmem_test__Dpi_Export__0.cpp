...
int Vdmem_test::simutil_get_scramble_key(svBitVecVal* val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdmem_test___024root::simutil_get_scramble_key\n"); );
    // Init
    ...
    Vdmem_test__Vcb_simutil_get_scramble_key_t __Vcb = (Vdmem_test__Vcb_simutil_get_scramble_key_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((Vdmem_test__Syms*)(__Vscopep->symsp()), val__Vcvt, simutil_get_scramble_key__Vfuncrtn__Vcvt);
...
int Vdmem_test::simutil_get_scramble_nonce(svBitVecVal* nonce) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdmem_test___024root::simutil_get_scramble_nonce\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    Vdmem_test__Vcb_simutil_get_scramble_nonce_t __Vcb = (Vdmem_test__Vcb_simutil_get_scramble_nonce_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((Vdmem_test__Syms*)(__Vscopep->symsp()), nonce__Vcvt, simutil_get_scramble_nonce__Vfuncrtn__Vcvt);
...
void Vdmem_test::simutil_memload(const char* file) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdmem_test___024root::simutil_memload\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    Vdmem_test__Vcb_simutil_memload_t __Vcb = (Vdmem_test__Vcb_simutil_memload_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    file__Vcvt = file;
    (*__Vcb)((Vdmem_test__Syms*)(__Vscopep->symsp()), file__Vcvt);
}

int Vdmem_test::simutil_set_mem(int index, const svBitVecVal* val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdmem_test___024root::simutil_set_mem\n"); );
    // Init
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    Vdmem_test__Vcb_simutil_set_mem_t __Vcb = (Vdmem_test__Vcb_simutil_set_mem_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    index__Vcvt = index;
    VL_SET_W_SVBV(312,val__Vcvt,val + 0);
(*__Vcb)((Vdmem_test__Syms*)(__Vscopep->symsp()), index__Vcvt, val__Vcvt, simutil_set_mem__Vfuncrtn__Vcvt);
...
int Vdmem_test::simutil_get_mem(int index, svBitVecVal* val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdmem_test___024root::simutil_get_mem\n"); );
    // Init
    IData/*31:0*/ index__Vcvt;
    index__Vcvt = 0;
    VlWide<10>/*311:0*/ val__Vcvt;
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    Vdmem_test__Vcb_simutil_get_mem_t __Vcb = (Vdmem_test__Vcb_simutil_get_mem_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    index__Vcvt = index;
    (*__Vcb)((Vdmem_test__Syms*)(__Vscopep->symsp()), index__Vcvt, val__Vcvt, simutil_get_mem__Vfuncrtn__Vcvt);
