...
void Vdmem_test___024root__trace_decl_types(VerilatedFst* tracep);

void Vdmem_test___024root__trace_init_top(Vdmem_test___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void Vdmem_test___024root__trace_register(Vdmem_test___024root* vlSelf, VerilatedFst* tracep);

VL_ATTR_COLD void Vdmem_test::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    (void)levels; (void)options;
    VerilatedFstC* const stfp = dynamic_cast<VerilatedFstC*>(tfp);
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vdmem_test::trace()' called on non-VerilatedFstC object;"
