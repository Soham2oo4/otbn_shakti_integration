...
VL_ATTR_COLD void Vadd_64_test___024unit___ctor_var_reset(Vadd_64_test___024unit* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vadd_64_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vadd_64_test___024unit___ctor_var_reset\n"); );
}
