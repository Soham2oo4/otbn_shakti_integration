#!/bin/bash
# =====================================================================
# build_soc_buswidth.sh - Configure and build SoC (fixed BUS_WIDTH = 128)
# =====================================================================
...
ROOT_DIR="$(dirname "$SCRIPT_DIR")"   # c-class directory
cd "$ROOT_DIR"
...
# ------------------------------
echo "=== Updating bus width in core configuration to 128 ==="
