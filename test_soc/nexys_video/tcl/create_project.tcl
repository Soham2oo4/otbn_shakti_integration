...
if { $argc != 6 } {
  ...
  puts " -tclargs <top-module> <xc7a200tsbg484-1> <riscv-isa> <jtag_type> <verilogdir> <axibuswidth>"
  exit 2
} else {
...
add_files -norecurse -fileset [get_filesets sources_1] $verilogdir ./test_soc/nexys_video/fpga_top.v
