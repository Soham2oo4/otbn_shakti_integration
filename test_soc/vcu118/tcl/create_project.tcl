...
if { $argc != 5 } {
  ...
  puts " -tclargs <top-module> <xcvu9p-flga2104-2L-e> <riscv-isa> <jtag_type> <verilogdir>"
  exit 2
} else {
...
add_files -norecurse -fileset [get_filesets sources_1] $verilogdir ./test_soc/vcu118/fpga_top.v
...
import_ip $ip_project_dir/manage_ip.srcs/sources_1/ip/vcu118mig/vcu118mig.xci
