...
if { $argc != 6 } {
  ...
  puts " -tclargs <top-module> <xcvu440-flga2892-1-c> <riscv-isa> <jtag_type> <verilogdir> <axibuswidth>"
  exit 2
} else {
...
set_property part xcvu440-flga2892-1-c [current_project]
...
add_files -norecurse -fileset [get_filesets sources_1] $verilogdir ./test_soc/profpga/fpga_top.v
...
import_ip $ip_project_dir/manage_ip.srcs/sources_1/ip/ddr4_0/ddr4_0.xci
