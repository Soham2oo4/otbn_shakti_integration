...
if { [get_ips -quiet ddr4_0] eq "" } {
    create_ip -vendor xilinx.com -library ip -version 2.2 -name ddr4 -module_name ddr4_0 
} else {
    reset_run ddr4_0_s
}
...
generate_target {instantiation_template} [get_ips ddr4_0]
create_ip_run [get_ips ddr4_0]
