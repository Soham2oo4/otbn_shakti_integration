 ...
 */
  ...
  (*synthesize*)
  module mkplic(Ifc_plic_axi4lite#(`paddr, `axil_buswidth, `USERSPACE, 31, 2, 7));
    let ifc();
  ...
  (*synthesize*)
  module mkpinmuxtop(Ifc_pinmux_axi4lite#(`paddr, `axil_buswidth, `USERSPACE));
    let ifc();
...
//      slave_num = `XADC_slave_num;
  ...
  module mkmixed_cluster(Ifc_mixed_cluster);
    ...
    AXI4_Lite_Fabric_IFC #(`MixedCluster_Num_Masters, `MixedCluster_Num_Slaves, `paddr, `axil_buswidth,`USERSPACE) 
