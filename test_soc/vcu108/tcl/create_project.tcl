...
if { $argc != 6 } {
  ...
  puts " -tclargs <top-module> <xcvu095-ffva2104-2-e> <riscv-isa> <jtag_type> <verilogdir> <axibuswidth>"
  exit 2
} else {
...
add_files -norecurse -fileset [get_filesets sources_1] $verilogdir ./test_soc/vcu108/fpga_top.v
...
import_ip $ip_project_dir/manage_ip.srcs/sources_1/ip/vcu108mig/vcu108mig.xci
