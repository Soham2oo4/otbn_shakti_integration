puts "\nDEBUG: Creating DDR4 IP\n"

if { [get_ips -quiet vcu108mig] eq "" } {
    create_ip -vendor xilinx.com -library ip -version 2.2 -name ddr4 -module_name vcu108mig 
} else {
    reset_run vcu108mig_synth_1
}
...
generate_target {instantiation_template} [get_ips vcu108mig]
create_ip_run [get_ips vcu108mig]
