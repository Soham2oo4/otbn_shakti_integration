  ...
  import Vector::*;
    ...
    (*always_ready,always_enabled,result="io"*) method
      ...
      interface PeripheralSideMSPI;
          interface Put#(Bit#(1)) clk_out;
          interface Put#(Bit#(1)) clk_outen;
          interface Get#(Bit#(1)) clk_in;
          interface Put#(Bit#(1)) nss_out;
          interface Put#(Bit#(1)) nss_outen;
          interface Get#(Bit#(1)) nss_in;
          interface Put#(Bit#(1)) mosi_out;
          interface Put#(Bit#(1)) mosi_outen;
          interface Get#(Bit#(1)) mosi_in;
          interface Put#(Bit#(1)) miso_out;
          interface Put#(Bit#(1)) miso_outen;
          interface Get#(Bit#(1)) miso_in;
      endinterface
   ...
   module mkpinmux(Ifc_pinmux);
      ...
      // allotted to it
      Wire#(Bit#(1)) wrmspi2_clk_out<-mkDWire(0);
      Wire#(Bit#(1)) wrmspi2_clk_in<-mkDWire(0);
      Wire#(Bit#(1)) wrmspi2_clk_outen<-mkDWire(0);
      Wire#(Bit#(1)) wrmspi2_nss_out<-mkDWire(0);
      Wire#(Bit#(1)) wrmspi2_nss_in<-mkDWire(0);
      Wire#(Bit#(1)) wrmspi2_nss_outen<-mkDWire(0);
      Wire#(Bit#(1)) wrmspi2_mosi_out<-mkDWire(0);
      Wire#(Bit#(1)) wrmspi2_mosi_in<-mkDWire(0);
      Wire#(Bit#(1)) wrmspi2_mosi_outen<-mkDWire(0);
      Wire#(Bit#(1)) wrmspi2_miso_out<-mkDWire(0);
      Wire#(Bit#(1)) wrmspi2_miso_in<-mkDWire(0);
      Wire#(Bit#(1)) wrmspi2_miso_outen<-mkDWire(0);
...
//			wrcell17_mux==2?wrpwm4_out: // pwm4_out is an output
      ...
      cell17_mux_outen=
			...
			wrcell17_mux==1?wrmspi2_nss_outen: // mspi_nss is an output
...
//			wrcell18_mux==2?wrpwm5_out:
      ...
      cell18_mux_outen=
			...
			wrcell18_mux==1?wrmspi2_mosi_outen: // mspi1_mosi is an output
      ...
      rule assign_wrgpioa_a11_in_on_cell18(wrcell18_mux==0);
        ...
        wrmspi2_mosi_in <= val0;
      endrule

      rule assign_wr_on_cell18_1(wrcell18_mux==1);
        wrmspi2_mosi_in <= cell18_mux_in;
        wrgpioa_a11_in<=val0;
      endrule
      ...
      cell19_mux_out=
			...
			wrcell19_mux==1?wrmspi2_miso_out: //mspi2_miso is an input
      ...
      cell19_mux_outen=
			...
			wrcell19_mux==1?wrmspi2_miso_outen: // mspi2_miso is an input
			wrcell19_mux==2?val0: // unused
			val0; // unused
      ...
      cell20_mux_out=
			...
			wrcell20_mux==1?wrmspi2_clk_out: // mspi2_clk is an output
			wrcell20_mux==2?val0:
			val0; // unused
      ...
      cell20_mux_outen=
			...
			wrcell20_mux==1?wrmspi2_clk_outen: // dedicated output
			wrcell20_mux==2?val0:
			val0; // unused
...
//        endinterface;
        ...
        interface mspi = interface PeripheralSideMSPI
            interface clk_out = interface Put
              ...
              endmethod
            endinterface;
            interface clk_outen = interface Put
              method Action put(Bit#(1) in);
                wrmspi2_clk_outen<= ~in;
              endmethod
            endinterface;
            interface clk_in= interface Get
              method ActionValue#(Bit#(1)) get;
                Bit#(1) tget;
                tget = wrmspi2_clk_in;
                return tget;
              endmethod
            endinterface;
            interface nss_out = interface Put
              method Action put(Bit#(1) in);
                wrmspi2_nss_out<=in;
              endmethod
            endinterface;
            interface nss_outen = interface Put
              method Action put(Bit#(1) in);
                wrmspi2_nss_outen<= ~in;
              endmethod
            endinterface;
            interface nss_in= interface Get
              method ActionValue#(Bit#(1)) get;
                Bit#(1) tget;
                tget = wrmspi2_nss_in;
                return tget;
              endmethod
            endinterface;
            interface mosi_out = interface Put
              method Action put(Bit#(1) in);
                wrmspi2_mosi_out <= in;
              endmethod
            endinterface;
            interface mosi_outen = interface Put
              method Action put(Bit#(1) in);
                wrmspi2_mosi_outen <= ~in;
              endmethod
            endinterface;
            interface mosi_in= interface Get
              method ActionValue#(Bit#(1)) get;
                Bit#(1) tget;
                tget = wrmspi2_mosi_in;
                return tget;
              endmethod
            endinterface;
            interface miso_in = interface Get
              method ActionValue#(Bit#(1)) get;
                Bit#(1) tget;
                tget = wrmspi2_miso_in;
                return tget;
              endmethod
            endinterface;
            interface miso_out = interface Put
              method Action put(Bit#(1) in);
                wrmspi2_miso_out <= in;
              endmethod
            endinterface;
            interface miso_outen = interface Put
              method Action put(Bit#(1) in);
                wrmspi2_miso_outen <= ~in;
              endmethod
            endinterface;
