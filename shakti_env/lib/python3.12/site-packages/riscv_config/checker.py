...
def hsregset():
    ...
    global inp_yaml
    temp = {'rv32': {'accessible': False}, 'rv64': {'accessible': False}}
    if 'S' in inp_yaml['ISA'] and 'H' in inp_yaml['ISA']:
      if 32 in inp_yaml['supported_xlen']:
        temp['rv32']['accessible'] = True
      if 64 in inp_yaml['supported_xlen']:
        temp['rv64']['accessible'] = True
...
def add_def_setters(schema_yaml):
    ...
    hsregsetter = lambda doc: hsregset()
    ...
    schema_yaml['vsstatus']['default_setter'] = hsregsetter
    ...
    schema_yaml['vsstatus']['schema']['rv64']['schema']['sum'][
        'default_setter'] = ssetter
    schema_yaml['vsie']['default_setter'] = hsregsetter
    ...
    schema_yaml['vsie']['schema']['rv64']['schema']['ssie'][
        'default_setter'] = ssetter
    schema_yaml['vsip']['default_setter'] = hsregsetter
    ...
    schema_yaml['vsip']['schema']['rv64']['schema']['ssip'][
        'default_setter'] = ssetter
    schema_yaml['vstvec']['default_setter'] = hsregsetter
    schema_yaml['vsepc']['default_setter'] = hsregsetter
    schema_yaml['vstval']['default_setter'] = hsregsetter
    schema_yaml['vscause']['default_setter'] = hsregsetter
    schema_yaml['vsatp']['default_setter'] = hsregsetter
    schema_yaml['vsscratch']['default_setter'] = hsregsetter
    return schema_yaml
