...
#^^^^^^^^^^
#
# **Description**: Indicates if clockgate is enabled for the fpu.
#
# **Examples**:
#
# .. code-block:: yaml
#
#   fpu_clockgate: False
fpu_clockgate: {type: boolean, default: False}
...
bus_protocol_configuration:
  ...
  schema:
    ...
    bus_width:
      type: integer
    axi4_transactor_fifo_depth:
      type: integer
    axi4_internal_fifo_depth:
      type: integer
    axi4_lite_transactor_fifo_depth:
      type: integer
    axi4_lite_internal_fifo_depth:
      type: integer
    axi4_id_width:
      type: integer
    userspace_width:
