...
`endif
	...
	interface Ifc_TCM_axi4#(numeric type addr_width,numeric type id_width, numeric type data_width, numeric type user_width, numeric type num_ver_banks, numeric type num_hor_banks, numeric type index_size);
	...
	module mkTCM_axi4#(String modulename, Integer base_address `ifdef testmode , Bool test_mode `endif )(Ifc_TCM_axi4#(addr_width,id_width,data_width,user_width,num_ver_banks,num_hor_banks,index_size))
								provisos(Add#(a__,index_size,addr_width),
												 Add#(f_,TLog#(TDiv#(data_width,8)),addr_width),
												 Add#(g_,TMul#(2,TLog#(TDiv#(data_width,8))),data_width),
												 Add#(h_,TLog#(TDiv#(data_width,8)),TMul#(2,TLog#(TDiv#(data_width,8)))),
